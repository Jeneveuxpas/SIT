...
#  ./launch.sh --config configs/attn_mse_repa_fade_stop_500_lr_3e-5.yaml --exp-name attn_mse_repa_fade_stop_500_lr_3e-5 --gpu 0,1,2,3 --num-gpus 4 --resume-step 500000
#  ./launch.sh --config configs/SiT-XL.yaml --exp-name SiT-XL --gpu 4,5,6,7 --num-gpus 4
