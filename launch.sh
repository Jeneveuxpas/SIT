...
#
# 用法: 
#   ./launch.sh --config configs/sit-xl-attnscaf-stage1-irepa-kvnorm-layernorm.yaml --exp-name attnscaf-stage1-irepa-kvnorm-layernorm --gpu 0,1,2,3,4,5,6,7 --num-gpus 8
#   
