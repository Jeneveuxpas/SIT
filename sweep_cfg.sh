...
#   ./sweep_cfg.sh --config configs/sit-xl-routing-stage1-stage2-irepa.yaml --exp-name sit-xl-routing-stage1-stage2-irepa \
...
# 默认参数
CONFIG="configs/sit-xl-routing-stage1-stage2-irepa.yaml"
EXP_NAME="sit-xl-routing-stage1-stage2-irepa"
STEPS="2000000"
